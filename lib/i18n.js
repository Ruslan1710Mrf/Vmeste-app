...
export const TRANSLATIONS = {
  ru: {
    ...
    'auth.errors.googleNotConfigured': 'Не удалось войти через Google. Попробуйте снова',
    ...
    'auth.errors.appleGeneric': 'Не удалось войти через Apple. Попробуйте снова',
    ...
    'memberDetail.inYourConnections': 'В ваших друзьях',
    'memberDetail.sendMessage': 'Написать сообщение',
    'memberDetail.addToConnections': 'Добавить в друзья',
    'memberDetail.mutualConnections': 'Общие друзья ({value})',
    ...
    'help.faq3.a': 'В «Нетворкинге» есть события, группы в Telegram/Discord и профили участников. Посещайте офлайн-встречи — это лучший способ найти друзей.',
    ...
    'help.faq5.a': 'Напишите нам на ruslan@vmestegroup.app — отвечаем на русском и английском в течение 24 часов.',
    ...
    'app.objectionableContentTitle': 'Недопустимый контент',
    'app.objectionableContentError': 'Сообщение содержит недопустимый контент и не может быть опубликовано.',
  ...
  en: {
    ...
    'auth.errors.googleNotConfigured': 'Failed to sign in with Google. Please try again',
    ...
    'auth.errors.appleGeneric': 'Failed to sign in with Apple. Please try again',
    ...
    'networking.communityMember': 'Community member',
    ...
    'help.faq5.a': 'Email us at ruslan@vmestegroup.app — we reply in Russian and English within 24 hours.',
    ...
    'app.objectionableContentTitle': 'Objectionable Content',
    'app.objectionableContentError': 'This message contains objectionable content and cannot be published.',
