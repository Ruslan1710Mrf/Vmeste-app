...
const BANNED_RU = [
  ...
  'мудак', 'мудил', 'мудо',
  // Прочий мат
  'залупа', 'гандон', 'шлюх', 'сука', 'сучка', 'хуесос',
  // долбоёб и все фонетические варианты: далбаёб/далбаеб/долбаеб/далбоеб
  // ё-варианты ловятся через корень 'ёб' выше; е-варианты через 'лбаеб'/'лбоеб'
  'долбоёб', 'долбоеб', 'лбаеб', 'лбоеб',
  'пиздюк', 'ёпт',
  // Слуры — ЛГБТК
  'пидор', 'пидар',
